...
function ShapeIcon({ shape }: { shape: string }) {
  ...
  if (shape === 'rounded-rect') return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="var(--lx-cta)" strokeWidth="1.9"><rect x="3" y="5" width="18" height="14" rx="4"/></svg>
  )
  if (shape === 'ovaal') return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="var(--lx-cta)" strokeWidth="1.9"><rect x="3" y="7" width="18" height="10" rx="5"/></svg>
  )
  if (shape === 'arc') return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="var(--lx-cta)" strokeWidth="1.9"><path d="M3 18 L3 12 A9 9 0 0 1 21 12 L21 18 Z"/></svg>
  )
  if (shape === 'sol') return (
    <svg width="15" height="15" viewBox="170 140 660 660">
  ...
  if (shape === 'luna') return (
    <svg width="15" height="15" viewBox="78 139 676 676">
