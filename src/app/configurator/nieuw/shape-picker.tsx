...
function ShapeIcon({ slug }: { slug: ShapeSlug }) {
  ...
  if (slug === 'sol') return (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      {/* Hoofdspiegel: kleine CW boog via bovenkant */}
      <path d="M10 34 A22 22 0 0 1 54 34" stroke="#9CA3AF" strokeWidth="2.5" strokeLinecap="round" />
      {/* Extra deel: grote CW boog via onderkant (~7px dip) */}
      <path d="M19 44 A15 15 0 1 1 45 44" stroke="#9CA3AF" strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  )
  return (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
