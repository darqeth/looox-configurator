...
export function DashboardContent({ data }: { data: DashboardData }) {
  const { isInternational, isGroothandel, korting, canOrder, configs, pendingOrderCount, changelogs, rssItems, downloads, circle, totalConfigCount, savedConfigCount, orderedConfigCount, revenueSum } = data
  ...
  return (
    <>
      ...
      {/* LoooX Circle — verborgen voor internationale en groothandel gebruikers */}
      {!isInternational && !isGroothandel && <div className="bg-white rounded-[18px] border border-black/6 shadow-sm overflow-hidden">
