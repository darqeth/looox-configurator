      ...
      <div className="mt-3 p-4 rounded-xl bg-[#FFFBEB] border border-[#FDE68A]">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={isPending}
            className="flex-1 px-3 py-2 rounded-xl bg-lx-cta text-white text-[12.5px] font-semibold hover:bg-lx-cta-hover transition-colors disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={isPending}
            className="flex-1 px-3 py-2 rounded-xl bg-white border border-red-200 text-red-600 text-[12.5px] font-semibold hover:bg-red-50 transition-colors disabled:opacity-50"
          >
            Afkeuren
          </button>
        </div>
